...
def music_loop():
    ...
    while True:
        ...
        # Stretch chunk based on music_speed
...
def challenge_loop(haptics):
    ...
    while True:
        # Wait random interval before next challenge
    ...
    while cap.isOpened():
        ...
        if hands:
            for hand_lms in hands:
                ...
                if challenge_active:
                    cv2.putText(frame, "⚡ Challenge! Index Up!", (50, 150),
