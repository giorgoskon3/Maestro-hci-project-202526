...
# Main
def main():
    global music_speed, current_volume, prev_volume, prev_speed, music_pitch, challenge_active, current_challenge, challenge_player, challenge_end_time, scores
    ...
    while cap.isOpened():
        ...
        if challenge_active and current_challenge is not None and challenge_player is not None:
            ...
            cv2.putText(frame, f"{prompt}  ({remaining:.1f}s)", (20, 160),
